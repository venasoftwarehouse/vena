...
import { Camera, History, Trash2, Calendar, CheckCircle, AlertTriangle, AlertCircle, Loader2, ChevronLeft, ChevronRight, ArrowLeft } from "lucide-react"
...
export default function HistoryPage() {
  ...
  const userId = paramUid.uid_user as string
  ...
  const uidHistory = paramUid.uid_history as string
  ...
  const handleDelete = async (id: string) => {
    ...
    try {
      ...
      await deleteDoc(doc(db, "users", userId, "history_scan", id))
      ...
      <AppLayout>
        <div className="p-4 md:p-6 lg:p-8 space-y-6 max-w-6xl mx-auto">
          ...
          <div className="space-y-2">
            <Button variant="ghost" size="sm" onClick={() => router.push("/app/doctor/")}>
              <ArrowLeft className="h-4 w-4 mr-2" />
              {t("doctorPage.buttons.back")}
            </Button>
            ...
            <Card className="border-border bg-card">
              <CardContent className="flex flex-col items-center justify-center py-12 text-center">
                ...
                <p className="text-muted-foreground mb-6 max-w-md">
                  {t("doctorPage.history.empty.description")}
                </p>
              </CardContent>
            </Card>
          ) : (
                    ...
                    <CardContent className="p-4">
                      <div className="flex items-center gap-4">
                        ...
                        <div className="flex flex-col gap-2">
                          <Link href={`/app/doctor/history/${userId}/${scan.id}`} passHref>
