  ...
  const loadScanDetail = async () => {
    ...
    try {
      ...
      if (scanData) {
        ...
        router.push(`/app/doctor/history/${uidUser}`)
      }
    } catch (error) {
        ...
        <AppLayout>
          <div className="p-4 flex items-center justify-center md:p-6 lg:p-8 space-y-6 max-w-6xl mx-auto">
            <div className="text-center">
              ...
              <Button onClick={() => router.push("/app/doctor/history")}>
    ...
    <AuthGuard>
      <AppLayout>
        <div className="p-4 md:p-6 lg:p-8 space-y-6 max-w-6xl mx-auto">
          {/* Header */}
          <div className="space-y-2">
            <Button variant="ghost" size="sm" onClick={() => router.push("/app/doctor/history/" + uidUser)}>
